        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-7">
          <div>
            ...
            >
              ...
              <span className="micro-label text-biolume">Featured Home, Decor and Craft Picks</span>
            </motion.div>
            <motion.h2
            ...
            >
              Featured <span className="gradient-text">Easyva Products</span>
            </motion.h2>
          </div>
          <motion.div
          ...
          >
            <Link to="/products" className="flex items-center gap-2 text-iris-light hover:text-biolume transition-colors micro-label">
              View All Products
              <ArrowRight size={14} />
            </Link>
          </motion.div>
